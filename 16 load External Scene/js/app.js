...
BjsApp.init = function(){
  ...
  //loadScene
  BABYLON.SceneLoader.Load('', 'assets/scenes/thiago_andrey_o_quarto.babylon', engine, function(scene){
    scene.executeWhenReady(function(){
      //attach camera to canvas
      //camera already comes inside the blender file so we just need to attach it
